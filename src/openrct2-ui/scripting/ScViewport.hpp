...
namespace OpenRCT2::Scripting
{
    ...
    private:
        ...
        void left_set(int32_t value)
        {
            ...
            if (viewport != nullptr)
            {
                SetViewLeftTop(value, viewport->ViewPosWorldY());
            }
        }
        ...
        void top_set(int32_t value)
        {
            ...
            if (viewport != nullptr)
            {
                SetViewLeftTop(viewport->ViewPosWorldX(), value);
            }
        }
        ...
        int32_t right_get() const
        {
            ...
            if (viewport != nullptr)
            {
                return viewport->ViewPosWorldX() + viewport->ViewWidth();
            }
            return 0;
        }
        void right_set(int32_t value)
        {
            ...
            if (viewport != nullptr)
            {
                SetViewLeftTop(value - viewport->ViewWidth(), viewport->ViewPosWorldY());
            }
        }
        ...
        int32_t bottom_get() const
        {
            ...
            if (viewport != nullptr)
            {
                return viewport->ViewPosWorldY() + viewport->ViewHeight();
            }
            return 0;
        }
        void bottom_set(int32_t value)
        {
            ...
            if (viewport != nullptr)
            {
                SetViewLeftTop(viewport->ViewPosWorldX(), value - viewport->ViewHeight());
            }
        }
        ...
        DukValue getCentrePosition() const
        {
            ...
            if (viewport != nullptr)
            {
                auto centre = viewport->ViewPosWorld()
        ...
        void SetViewLeftTop(int32_t left, int32_t top)
        {
            ...
            if (w != nullptr)
            {
                ...
                if (viewport != nullptr)
                {
                    ...
                    w->savedViewPos = viewport->ViewPosWorld();
                    viewport->Invalidate();
                }
            }
        }
