...
namespace OpenRCT2::Scripting
{
    ...
    private:
        static JSValue GetFunctionIndexArray(
            JSContext* ctx, const std::vector<OpenRCT2::Profiling::Function*>& all,
            const std::vector<OpenRCT2::Profiling::Function*>& items)
        {
        ...
        {
            return JS_NewBool(ctx, OpenRCT2::Profiling::IsEnabled());
        }
